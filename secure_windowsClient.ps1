# Created by Matthew Dudzinski on 11/1/2024 at 7:22 AM CST
# For use in Windows 10 and Windows 11 environments, this script sets the execution policy to RemoteSigned for the current user and checks if the script is running as an administrator.
...
# Script warns host that it is running with the appropriate execution policy and administrative privileges.
Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope LocalMachine
Write-Host "Script is running with the appropriate execution policy and administrative privileges."
